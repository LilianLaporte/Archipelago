...
string error::too_much_node()
{
	return string("Too much node");
}

string error::link_to_itself()
{
	return string("Node cannot connect to itself");
}

string error::not_enough_node()
{
	return string("There is nothing to edit : note enough nodes");
}

string error::not_selected()
{
	return string("Please select first a node to edit");
}
